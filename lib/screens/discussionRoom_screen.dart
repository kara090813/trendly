          ...
          Column(
            children: [
              ...
              _buildCommentItem(
                nickname: "나는 첫gpt",
                time: "20분전",
                content: "크레스티드 게코는 머리 위에 눈썹 모양의 돌기를 가지고 있어요. 이 돌기 덕분에 더욱 개성 넘치는 외모를 자랑하죠 몸 색깔과 무늬도 다양해서 보는 재미가 있답니다. 아무튼 관련된 내용입니다. 게코는 귀엽습니다. 진짜 한번만 만져보세요 클레이 같아요.",
                likes: 546,
                dislikes: 5216,
                comments: 5216,
              ),
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.grey[300], // 더 진한 배경색
          ...
          // 아이디/비밀번호와 텍스트 입력 사이 구분선
          Divider(
            height: 24.h, // 구분선 전후 간격 포함
            thickness: 1,
            color: Colors.grey.withOpacity(0.2),
          ),

          // 댓글 입력 및 전송 버튼 (더 큰 영역)
          Row(
            children: [
              Expanded(
                child: Container(
                  padding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 12.h), // 높이 증가
                  child: Text(
                    "생각을 공유해주세요 :)",
                    style: TextStyle(
                      fontSize: 15.sp, // 크기 약간 증가
                      color: Colors.grey[500],
                    ),
                  ),
                ),
